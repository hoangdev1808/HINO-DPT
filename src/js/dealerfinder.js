					...
					success: function(msg) {
						...
						if (results.length > 0) {
							...
							jQuery.each(results, function(k, v) {
								...
								if (number > 9) {
									$("<div class='hino-helper2__left__content' data-src='" + v.getAttribute("des") + "' id='l_" + marker['__gm_id'] + "'><div class='hino-helper2__left__content__title'><h2>" + v.getAttribute("name") + "</h2></div><div class='hino-helper2__left__content__desc'><ul><li><em class='material-icons'>place</em><p>" + v.getAttribute("address") + "</p></li><li><em class='material-icons'>call</em><p>" + lang[currCulture].phone + ': ' + v.getAttribute("phone") + "</p></li><li><p>" + lang[currCulture].fax + ': ' + v.getAttribute("fax") + "<p></li><li><em class='material-icons'>email</em><p>" + v.getAttribute("email") + "</p></li></ul></div></div>")
										.click(function() {
