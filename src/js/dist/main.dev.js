...
var activeHeaderWhenScroll = function activeHeaderWhenScroll() {
...
var checkLayoutBanner = function checkLayoutBanner() {
  var pagesBanner = $("#page-banner");
  var breadcrumb = $('.global-breadcrumb');
  var heightHeader = $("header").outerHeight();
  var mainBanner = $("#home-banner");
  var mobileWrap = $("header .mobile-wrap ");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  checkLayoutBanner();
  readMore();
  detailProjectThumbs(); // showBackToTop();
